...
## 2. المصفوفة الكاملة (114 صلاحية مستأجر + 8 منصة)
...
| `course.manage_all` | نطاق كامل على المقررات/الشُعب/التسجيل (بدونها: المدرس يرى شُعبه والطالب تسجيلاته فقط — FR-ENR-002) | ● | ● | — | — |
