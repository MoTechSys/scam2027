...
| التقدّم | **21 / 65 مهمة (32%)** — P0 كامل (16/16) · P1 5/15 · P2–P5 لم تبدأ. انظر §4 |
| التالي مباشرة | **P1-06 الملفات** (`lib/storage`, `/files`, رفع/تنزيل موقّع) ثم P1-07 الإشعارات — §5 |
...
- `seed.ts` يبذر المستأجر والأدوار والمستخدمين والبنية الأكاديمية والمقررات/الشُعب/30 طالبًا؛ **لا ملفات ولا إشعارات** بعد (تُوسَّع مع P1-06/07).
