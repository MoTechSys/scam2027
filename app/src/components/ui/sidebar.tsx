    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          disableTransition ? "transition-none" : "transition-[inset-inline,width] duration-200 ease-linear",
          side === "start"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "in-data-[side=end]:cursor-ew-resize in-data-[side=start]:cursor-ew-resize",
        "[[data-side=end][data-state=collapsed]_&]:cursor-ew-resize [[data-side=start][data-state=collapsed]_&]:cursor-ew-resize",
