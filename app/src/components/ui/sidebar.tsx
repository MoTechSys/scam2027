  ...
  return (
    <button
      ...
      className={cn(
        ...
        "in-data-[side=start]:cursor-ew-resize in-data-[side=end]:cursor-ew-resize",
        "[[data-side=start][data-state=collapsed]_&]:cursor-ew-resize [[data-side=end][data-state=collapsed]_&]:cursor-ew-resize",
